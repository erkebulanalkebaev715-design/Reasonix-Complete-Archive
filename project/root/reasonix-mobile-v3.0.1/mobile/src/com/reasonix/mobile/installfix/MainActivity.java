...
public final class MainActivity extends Activity {
    ...
    // Pushed by the WebView (setBackLayer) on every layer change so the system
    // Back key closes the top layer deterministically: sheet, drawer, screen,
    // then WebView history, then default app exit.
    private volatile String backLayer = "none";
    ...
    public final class NativeBridge {
        ...
        public void setBackLayer(String layer) {
            backLayer = (layer == null) ? "none" : layer;
        }
    }
    ...
    public void onBackPressed() {
        if (webView != null) {
            String layer = backLayer;
            if ("sheet".equals(layer) || "drawer".equals(layer) || "screen".equals(layer)) {
                final String script = "window.__backClose&&window.__backClose(" + JSONObject.quote(layer) + ");";
