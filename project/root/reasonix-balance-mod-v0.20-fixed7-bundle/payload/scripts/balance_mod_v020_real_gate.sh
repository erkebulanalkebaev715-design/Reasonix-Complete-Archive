...
grep -q 'strict-one-paid-attempt-v0.20-fixed7' internal/agent/run_budget.go || fail 'Fixed7 core marker missing; refusing paid API call'
...
echo '  core marker=Fixed7 | obsolete 66-way reserve=ABSENT | provider retries=0 | body replay=off | reasoning replay=off'
