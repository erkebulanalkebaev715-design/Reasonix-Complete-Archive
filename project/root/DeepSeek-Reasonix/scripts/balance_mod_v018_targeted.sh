...
grep -Eq 'const balanceModVersion = "balance-mod-v0\.(18|19|20)"' internal/serve/mod_bridge.go
...
assert p['modVersion'] in ('balance-mod-v0.18','balance-mod-v0.19','balance-mod-v0.20'), p
