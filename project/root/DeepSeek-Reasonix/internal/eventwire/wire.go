...
type Event struct {
	...
	// Swarm is set on swarm_* events (Reasonix 3.0). Structured orchestration
	// state only; never raw transcripts, prompts, or hidden reasoning.
	Swarm *SwarmEvent `json:"swarm,omitempty"`
}

// SwarmEvent is the JSON form of event.SwarmEvent.
type SwarmEvent struct {
	SwarmID  string `json:"swarmId,omitempty"`
	TaskID   string `json:"taskId,omitempty"`
	WorkerID string `json:"workerId,omitempty"`
	SubEvent string `json:"subEvent,omitempty"`
...
func ToWire(e event.Event) Event {
	...
	case event.SwarmStarted, event.SwarmTaskCreated, event.SwarmTaskAssigned,
		event.SwarmAgentStarted, event.SwarmAgentReasoning, event.SwarmAgentToolDispatch,
		event.SwarmAgentToolResult, event.SwarmAgentCompleted, event.SwarmAgentFailed,
		event.SwarmTaskCompleted, event.SwarmTaskFailed, event.SwarmMergeStarted,
		event.SwarmMergeCompleted, event.SwarmVerificationStarted, event.SwarmVerificationCompleted,
		event.SwarmCompleted, event.SwarmFailed, event.SwarmCancelled:
		w.Swarm = toWireSwarm(e)
	}
	return w
}

func toWireSwarm(e event.Event) *SwarmEvent {
	if e.Swarm == nil {
		return nil
	}
	return &SwarmEvent{
		SwarmID: e.Swarm.SwarmID, TaskID: e.Swarm.TaskID, WorkerID: e.Swarm.WorkerID,
		SubEvent: e.Swarm.SubEvent, Status: e.Swarm.Status, ModelRef: e.Swarm.ModelRef,
		Provider: e.Swarm.Provider, Summary: e.Swarm.Summary, Failure: e.Swarm.Failure,
	}
}
...
var kindNames = map[event.Kind]string{
	...
	event.SwarmStarted:               "swarm_started",
	event.SwarmTaskCreated:           "swarm_task_created",
	event.SwarmTaskAssigned:          "swarm_task_assigned",
	event.SwarmAgentStarted:          "swarm_agent_started",
	event.SwarmAgentReasoning:        "swarm_agent_reasoning",
	event.SwarmAgentToolDispatch:     "swarm_agent_tool_dispatch",
	event.SwarmAgentToolResult:       "swarm_agent_tool_result",
	event.SwarmAgentCompleted:        "swarm_agent_completed",
	event.SwarmAgentFailed:           "swarm_agent_failed",
	event.SwarmTaskCompleted:         "swarm_task_completed",
	event.SwarmTaskFailed:            "swarm_task_failed",
	event.SwarmMergeStarted:          "swarm_merge_started",
	event.SwarmMergeCompleted:        "swarm_merge_completed",
	event.SwarmVerificationStarted:   "swarm_verification_started",
	event.SwarmVerificationCompleted: "swarm_verification_completed",
	event.SwarmCompleted:             "swarm_completed",
	event.SwarmFailed:                "swarm_failed",
	event.SwarmCancelled:             "swarm_cancelled",
}
