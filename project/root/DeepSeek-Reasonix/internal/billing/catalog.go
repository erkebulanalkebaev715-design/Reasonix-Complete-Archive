...
func OfficialCatalog() []CatalogEntry {
	entries := []CatalogEntry{
		...
		{Provider: "deepseek", Model: "deepseek-v4-flash", Currency: "CNY", CacheHit: 0.10, Input: 3, Output: 9, DocURL: DocDeepSeekPricing, BillingMode: BillingModePAYG},
		{Provider: "deepseek", Model: "deepseek-v4-pro", Currency: "CNY", CacheHit: 0.30, Input: 9, Output: 27, DocURL: DocDeepSeekPricing, BillingMode: BillingModePAYG},
		{Provider: "deepseek", Model: "deepseek-v4-flash", Currency: "USD", CacheHit: 0.014, Input: 0.44, Output: 1.32, DocURL: DocDeepSeekPricing, BillingMode: BillingModePAYG},
		{Provider: "deepseek", Model: "deepseek-v4-pro", Currency: "USD", CacheHit: 0.044, Input: 1.32, Output: 3.96, DocURL: DocDeepSeekPricing, BillingMode: BillingModePAYG},
