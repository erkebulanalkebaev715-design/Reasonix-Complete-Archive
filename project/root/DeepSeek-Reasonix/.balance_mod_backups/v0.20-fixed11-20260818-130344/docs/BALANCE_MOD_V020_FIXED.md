...
## Fixed4
Adds explicit provider price required by v0.16 strict pre-call admission. Uses worst-case peak pricing for conservative KZT accounting and reports the time-band rate-card estimate separately.
