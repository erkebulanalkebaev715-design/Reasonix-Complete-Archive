...
echo '[REAL 2/14] verify strict hard-budget one-paid-attempt policy'
...
echo '  hidden provider retries=0 | body replay=off | reasoning fallback replay=off'
...
want=m['pricingSnapshot']['deepseek-v4-flash']['peak']
...
print(f"  pricing=KNOWN | conservative peak hit={price['cache_hit']}/M input={price['input']}/M output={price['output']}/M USD")
PY
