...
BRIDGE_VERSION = 'reasonix-mobile-v1.4.0'
...
def make_handler(core:MobileCore):
    class H(BaseHTTPRequestHandler):
        server_version='ReasonixMobileBridge/1.4.0'
        ...
        def handle_api(self,method):
            ...
            try:
                ...
                if u.path=='/mobile/info' and method=='GET':
                    self.send_json(200,{'model':core.model,'upstream':core.upstream,'root':str(core.root),'skillsRoot':str(core.skills_root),'androidTools':str(core.android_tools_script),'bridgeVersion':'1.4.0'});return
                n=int(self.headers.get('Content-Length','0') or 0)
