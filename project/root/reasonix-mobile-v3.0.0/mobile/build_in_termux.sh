...
apksigner sign \
  ...
  --out build/Reasonix-Mobile-v3.0.0.apk build/aligned.apk
apksigner verify --verbose --print-certs build/Reasonix-Mobile-v3.0.0.apk
sha256sum build/Reasonix-Mobile-v3.0.0.apk | tee build/SHA256.txt
cp build/Reasonix-Mobile-v3.0.0.apk /sdcard/Download/
cp build/SHA256.txt /sdcard/Download/Reasonix-Mobile-v3.0.0-SHA256.txt
printf '\nVOICE_BUILD_READY\nAPK=/sdcard/Download/Reasonix-Mobile-v3.0.0.apk\n'
