...
apksigner sign \
  ...
  --out build/Reasonix-Mobile-v2.0.7-RC.apk build/aligned.apk
apksigner verify --verbose --print-certs build/Reasonix-Mobile-v2.0.7-RC.apk
sha256sum build/Reasonix-Mobile-v2.0.7-RC.apk | tee build/SHA256.txt
cp build/Reasonix-Mobile-v2.0.7-RC.apk /sdcard/Download/
cp build/SHA256.txt /sdcard/Download/Reasonix-Mobile-v2.0.7-RC-SHA256.txt
printf '\nVOICE_BUILD_READY\nAPK=/sdcard/Download/Reasonix-Mobile-v2.0.7-RC.apk\n'
