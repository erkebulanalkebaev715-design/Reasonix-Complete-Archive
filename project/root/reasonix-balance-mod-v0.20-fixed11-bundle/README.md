...
## Fixed11
Fixed11 adds an env-gated exact provider Usage receipt at Agent.emitTurnUsage and reconciles it against the KZT ledger. No provider call occurs during installation.
